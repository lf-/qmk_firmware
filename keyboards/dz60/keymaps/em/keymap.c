...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_60_ansi(
        ...
        KC_TRNS,          KC_TRNS, KC_TRNS,   KC_END,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,  KC_TRNS, KC_PSCR, KC_TRNS, KC_TRNS, RESET,
        KC_TRNS,          KC_HOME, KC_TRNS,   KC_TRNS, KC_PGDN, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS,          LIG_DEC, CYCLE_RGB, LIG_INC, KC_TRNS, KC_PGUP, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS,          KC_TRNS,
